...
: ${AMENT_CURRENT_PREFIX:="/home/entity014/3GP6-bot/robot_ws/install/robot_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_core/environment/pythonpath.sh"
